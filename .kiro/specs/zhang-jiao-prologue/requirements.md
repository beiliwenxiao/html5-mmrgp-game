...
**用户故事:** 作为玩家，我希望通过渐进式的教程提示学习游戏操作，以便自然地掌握游戏机制

#### 验收标准

1. 当玩家进入第一幕场景时，游戏客户端应当显示第一条提示"你从黑暗中醒来，饥寒交迫。按 C 查看属性"
2. 当玩家按下C键后，游戏客户端应当打开属性面板并显示第二条提示"你四处走了走，看了看。按WASD移动"
3. 当场景中出现可拾取物品时，游戏客户端应当显示第三条提示"你发现一些物品。按E键拾取"
4. 当玩家拾取完成后，游戏客户端应当显示第四条提示"按B键查看背包"
5. 当玩家按B键打开背包后，游戏客户端应当显示第五条提示"点击物品装备"
6. 当玩家点击物品装备后，游戏客户端应当显示第六条提示"按V键查看装备"
7. 当每条提示显示时，游戏客户端应当使用对话框样式呈现，包含文字和半透明背景
8. 当玩家完成当前提示的操作后，游戏客户端应当自动隐藏当前提示并显示下一条提示
9. 当所有教程提示完成后，游戏客户端应当标记教程为已完成状态
